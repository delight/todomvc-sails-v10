(function () {
	...
	angular.module('sails.io', [])
		.factory('sailsSocketFactory', ['$rootScope', '$http', '$timeout', '$location', '$log', sailsSocketFactory]);

	function sailsSocketFactory($rootScope, $http, $timeout, $location, $log) {
